...
NITE_VERSION_MINOR = 2
NITE_VERSION_MAINTENANCE = 0
NITE_VERSION_BUILD = 10
NITE_VERSION = ( NITE_VERSION_MAJOR * 100000000 + NITE_VERSION_MINOR * 1000000 + NITE_VERSION_MAINTENANCE * 10000 + NITE_VERSION_BUILD )
...
from _openni2 import OniStatus
from _openni2 import OniSensorType
from _openni2 import OniPixelFormat
from _openni2 import OniDeviceState
from _openni2 import OniImageRegistrationMode
...
from _openni2 import OniCallbackHandleImpl
from _openni2 import OniVersion
from _openni2 import OniVideoMode
from _openni2 import OniSensorInfo
from _openni2 import OniDeviceInfo
...
from _openni2 import OniFrame
from _openni2 import OniDeviceCallbacks
from _openni2 import OniCropping
from _openni2 import OniRGB888Pixel
from _openni2 import OniYUV422DoublePixel
from _openni2 import OniSeek
class NiteJointType(CEnum):
    _names_ = {'NITE_JOINT_RIGHT_ELBOW': 5, 'NITE_JOINT_LEFT_ELBOW': 4, 'NITE_JOINT_RIGHT_KNEE': 12, 'NITE_JOINT_RIGHT_HAND': 7, 'NITE_JOINT_RIGHT_SHOULDER': 3, 'NITE_JOINT_HEAD': 0, 'NITE_JOINT_LEFT_HAND': 6, 'NITE_JOINT_LEFT_SHOULDER': 2, 'NITE_JOINT_LEFT_KNEE': 11, 'NITE_JOINT_TORSO': 8, 'NITE_JOINT_NECK': 1, 'NITE_JOINT_LEFT_HIP': 9, 'NITE_JOINT_RIGHT_HIP': 10, 'NITE_JOINT_LEFT_FOOT': 13, 'NITE_JOINT_RIGHT_FOOT': 14}
    _values_ = {0: 'NITE_JOINT_HEAD', 1: 'NITE_JOINT_NECK', 2: 'NITE_JOINT_LEFT_SHOULDER', 3: 'NITE_JOINT_RIGHT_SHOULDER', 4: 'NITE_JOINT_LEFT_ELBOW', 5: 'NITE_JOINT_RIGHT_ELBOW', 6: 'NITE_JOINT_LEFT_HAND', 7: 'NITE_JOINT_RIGHT_HAND', 8: 'NITE_JOINT_TORSO', 9: 'NITE_JOINT_LEFT_HIP', 10: 'NITE_JOINT_RIGHT_HIP', 11: 'NITE_JOINT_LEFT_KNEE', 12: 'NITE_JOINT_RIGHT_KNEE', 13: 'NITE_JOINT_LEFT_FOOT', 14: 'NITE_JOINT_RIGHT_FOOT'}
    NITE_JOINT_HEAD = 0
    NITE_JOINT_NECK = 1
...
class NiteSkeletonState(CEnum):
    _names_ = {'NITE_SKELETON_CALIBRATION_ERROR_HEAD': 5, 'NITE_SKELETON_CALIBRATION_ERROR_NOT_IN_POSE': 3, 'NITE_SKELETON_TRACKED': 2, 'NITE_SKELETON_CALIBRATION_ERROR_LEGS': 6, 'NITE_SKELETON_CALIBRATION_ERROR_HANDS': 4, 'NITE_SKELETON_CALIBRATING': 1, 'NITE_SKELETON_CALIBRATION_ERROR_TORSO': 7, 'NITE_SKELETON_NONE': 0}
    _values_ = {0: 'NITE_SKELETON_NONE', 1: 'NITE_SKELETON_CALIBRATING', 2: 'NITE_SKELETON_TRACKED', 3: 'NITE_SKELETON_CALIBRATION_ERROR_NOT_IN_POSE', 4: 'NITE_SKELETON_CALIBRATION_ERROR_HANDS', 5: 'NITE_SKELETON_CALIBRATION_ERROR_HEAD', 6: 'NITE_SKELETON_CALIBRATION_ERROR_LEGS', 7: 'NITE_SKELETON_CALIBRATION_ERROR_TORSO'}
...
class NiteUserState(CEnum):
    _names_ = {'NITE_USER_STATE_VISIBLE': 1, 'NITE_USER_STATE_NEW': 2, 'NITE_USER_STATE_LOST': 4}
    _values_ = {1: 'NITE_USER_STATE_VISIBLE', 2: 'NITE_USER_STATE_NEW', 4: 'NITE_USER_STATE_LOST'}
...
class NitePoseState(CEnum):
    _names_ = {'NITE_POSE_STATE_IN_POSE': 2, 'NITE_POSE_STATE_ENTER': 4, 'NITE_POSE_STATE_DETECTING': 1, 'NITE_POSE_STATE_EXIT': 8}
    _values_ = {8: 'NITE_POSE_STATE_EXIT', 1: 'NITE_POSE_STATE_DETECTING', 2: 'NITE_POSE_STATE_IN_POSE', 4: 'NITE_POSE_STATE_ENTER'}
...
class NiteHandState(CEnum):
    _names_ = {'NITE_HAND_STATE_NEW': 1, 'NITE_HAND_STATE_TRACKED': 2, 'NITE_HAND_STATE_LOST': 0, 'NITE_HAND_STATE_TOUCHING_FOV': 4}
    _values_ = {0: 'NITE_HAND_STATE_LOST', 1: 'NITE_HAND_STATE_NEW', 2: 'NITE_HAND_STATE_TRACKED', 4: 'NITE_HAND_STATE_TOUCHING_FOV'}
...
class NiteSkeleton(ctypes.Structure):
    ...
    def __repr__(self):
        return 'NiteSkeleton(joints = %r, state = %r)' % (self.joints, self.state)
...
def load_dll(dllname):
    ...
    _niteInitializeUserTrackerByDevice = _dll.niteInitializeUserTrackerByDevice
    ...
    _niteShutdownUserTracker = _dll.niteShutdownUserTracker
    ...
    _niteStartSkeletonTracking = _dll.niteStartSkeletonTracking
    ...
    _niteStopSkeletonTracking = _dll.niteStopSkeletonTracking
    ...
    _niteIsSkeletonTracking = _dll.niteIsSkeletonTracking
    ...
    _niteSetSkeletonSmoothing = _dll.niteSetSkeletonSmoothing
    ...
    _niteGetSkeletonSmoothing = _dll.niteGetSkeletonSmoothing
    ...
    _niteStartPoseDetection = _dll.niteStartPoseDetection
    ...
    _niteStopPoseDetection = _dll.niteStopPoseDetection
    ...
    _niteStopAllPoseDetection = _dll.niteStopAllPoseDetection
    ...
    _niteRegisterUserTrackerCallbacks = _dll.niteRegisterUserTrackerCallbacks
    _niteRegisterUserTrackerCallbacks.restype  = NiteStatus
    _niteRegisterUserTrackerCallbacks.argtypes = [NiteUserTrackerHandle, ctypes.POINTER(NiteUserTrackerCallbacks), ctypes.c_void_p]

    global _niteUnregisterUserTrackerCallbacks
    _niteUnregisterUserTrackerCallbacks = _dll.niteUnregisterUserTrackerCallbacks
    ...
    _niteReadUserTrackerFrame = _dll.niteReadUserTrackerFrame
    ...
    _niteUserTrackerFrameAddRef = _dll.niteUserTrackerFrameAddRef
    ...
    _niteUserTrackerFrameRelease = _dll.niteUserTrackerFrameRelease
    ...
    _niteInitializeHandTracker = _dll.niteInitializeHandTracker
    ...
    _niteInitializeHandTrackerByDevice = _dll.niteInitializeHandTrackerByDevice
    ...
    _niteShutdownHandTracker = _dll.niteShutdownHandTracker
    ...
    _niteStartHandTracking = _dll.niteStartHandTracking
    ...
    _niteStopHandTracking = _dll.niteStopHandTracking
    ...
    _niteStopAllHandTracking = _dll.niteStopAllHandTracking
    ...
    _niteSetHandSmoothingFactor = _dll.niteSetHandSmoothingFactor
    ...
    _niteGetHandSmoothingFactor = _dll.niteGetHandSmoothingFactor
    ...
    _niteRegisterHandTrackerCallbacks = _dll.niteRegisterHandTrackerCallbacks
    _niteRegisterHandTrackerCallbacks.restype  = NiteStatus
    _niteRegisterHandTrackerCallbacks.argtypes = [NiteHandTrackerHandle, ctypes.POINTER(NiteHandTrackerCallbacks), ctypes.c_void_p]

    global _niteUnregisterHandTrackerCallbacks
    _niteUnregisterHandTrackerCallbacks = _dll.niteUnregisterHandTrackerCallbacks
    ...
    _niteReadHandTrackerFrame = _dll.niteReadHandTrackerFrame
    ...
    _niteHandTrackerFrameAddRef = _dll.niteHandTrackerFrameAddRef
    ...
    _niteHandTrackerFrameRelease = _dll.niteHandTrackerFrameRelease
    ...
    _niteStartGestureDetection = _dll.niteStartGestureDetection
    ...
    _niteStopGestureDetection = _dll.niteStopGestureDetection
    ...
    _niteStopAllGestureDetection = _dll.niteStopAllGestureDetection
    ...
    _niteConvertJointCoordinatesToDepth = _dll.niteConvertJointCoordinatesToDepth
    _niteConvertJointCoordinatesToDepth.restype  = NiteStatus
    _niteConvertJointCoordinatesToDepth.argtypes = [NiteUserTrackerHandle, ctypes.c_float, ctypes.c_float, ctypes.c_float, ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float)]

    global _niteConvertDepthCoordinatesToJoint
    _niteConvertDepthCoordinatesToJoint = _dll.niteConvertDepthCoordinatesToJoint
    _niteConvertDepthCoordinatesToJoint.restype  = NiteStatus
    _niteConvertDepthCoordinatesToJoint.argtypes = [NiteUserTrackerHandle, ctypes.c_int, ctypes.c_int, ctypes.c_int, ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float)]

    global _niteConvertHandCoordinatesToDepth
    _niteConvertHandCoordinatesToDepth = _dll.niteConvertHandCoordinatesToDepth
    _niteConvertHandCoordinatesToDepth.restype  = NiteStatus
    _niteConvertHandCoordinatesToDepth.argtypes = [NiteHandTrackerHandle, ctypes.c_float, ctypes.c_float, ctypes.c_float, ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float)]

    global _niteConvertDepthCoordinatesToHand
    _niteConvertDepthCoordinatesToHand = _dll.niteConvertDepthCoordinatesToHand
    _niteConvertDepthCoordinatesToHand.restype  = NiteStatus
    _niteConvertDepthCoordinatesToHand.argtypes = [NiteHandTrackerHandle, ctypes.c_int, ctypes.c_int, ctypes.c_int, ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float)]
