...
ONI_VERSION = ( ONI_VERSION_MAJOR * 100000000 + ONI_VERSION_MINOR * 1000000 + ONI_VERSION_MAINTENANCE * 10000 + ONI_VERSION_BUILD )
ONI_CREATE_API_VERSION = lambda major, minor: ( ( major ) * 1000 + ( minor ) )
...
class OniStatus(CEnum):
    _names_ = {'ONI_STATUS_NOT_SUPPORTED': 3, 'ONI_STATUS_OK': 0, 'ONI_STATUS_TIME_OUT': 102, 'ONI_STATUS_ERROR': 1, 'ONI_STATUS_NOT_IMPLEMENTED': 2, 'ONI_STATUS_NO_DEVICE': 6, 'ONI_STATUS_OUT_OF_FLOW': 5, 'ONI_STATUS_BAD_PARAMETER': 4}
    _values_ = {0: 'ONI_STATUS_OK', 1: 'ONI_STATUS_ERROR', 2: 'ONI_STATUS_NOT_IMPLEMENTED', 3: 'ONI_STATUS_NOT_SUPPORTED', 4: 'ONI_STATUS_BAD_PARAMETER', 5: 'ONI_STATUS_OUT_OF_FLOW', 6: 'ONI_STATUS_NO_DEVICE', 102: 'ONI_STATUS_TIME_OUT'}
    ONI_STATUS_OK = 0
    ONI_STATUS_ERROR = 1
...
class OniSensorType(CEnum):
    _names_ = {'ONI_SENSOR_IR': 1, 'ONI_SENSOR_COLOR': 2, 'ONI_SENSOR_DEPTH': 3}
    _values_ = {1: 'ONI_SENSOR_IR', 2: 'ONI_SENSOR_COLOR', 3: 'ONI_SENSOR_DEPTH'}
    ONI_SENSOR_IR = 1
    ONI_SENSOR_COLOR = 2
    ONI_SENSOR_DEPTH = 3

class OniPixelFormat(CEnum):
    _names_ = {'ONI_PIXEL_FORMAT_RGB888': 200, 'ONI_PIXEL_FORMAT_JPEG': 204, 'ONI_PIXEL_FORMAT_GRAY8': 202, 'ONI_PIXEL_FORMAT_DEPTH_1_MM': 100, 'ONI_PIXEL_FORMAT_YUYV': 205, 'ONI_PIXEL_FORMAT_YUV422': 201, 'ONI_PIXEL_FORMAT_SHIFT_9_3': 103, 'ONI_PIXEL_FORMAT_SHIFT_9_2': 102, 'ONI_PIXEL_FORMAT_GRAY16': 203, 'ONI_PIXEL_FORMAT_DEPTH_100_UM': 101}
    _values_ = {100: 'ONI_PIXEL_FORMAT_DEPTH_1_MM', 101: 'ONI_PIXEL_FORMAT_DEPTH_100_UM', 102: 'ONI_PIXEL_FORMAT_SHIFT_9_2', 103: 'ONI_PIXEL_FORMAT_SHIFT_9_3', 200: 'ONI_PIXEL_FORMAT_RGB888', 201: 'ONI_PIXEL_FORMAT_YUV422', 202: 'ONI_PIXEL_FORMAT_GRAY8', 203: 'ONI_PIXEL_FORMAT_GRAY16', 204: 'ONI_PIXEL_FORMAT_JPEG', 205: 'ONI_PIXEL_FORMAT_YUYV'}
...
class OniDeviceState(CEnum):
    _names_ = {'ONI_DEVICE_STATE_ERROR': 1, 'ONI_DEVICE_STATE_NOT_READY': 2, 'ONI_DEVICE_STATE_EOF': 3, 'ONI_DEVICE_STATE_OK': 0}
    _values_ = {0: 'ONI_DEVICE_STATE_OK', 1: 'ONI_DEVICE_STATE_ERROR', 2: 'ONI_DEVICE_STATE_NOT_READY', 3: 'ONI_DEVICE_STATE_EOF'}
...
class OniImageRegistrationMode(CEnum):
    _names_ = {'ONI_IMAGE_REGISTRATION_DEPTH_TO_COLOR': 1, 'ONI_IMAGE_REGISTRATION_OFF': 0}
    _values_ = {0: 'ONI_IMAGE_REGISTRATION_OFF', 1: 'ONI_IMAGE_REGISTRATION_DEPTH_TO_COLOR'}
...
class _anon_enum_16(CEnum):
    _names_ = {'ONI_DEVICE_PROPERTY_PLAYBACK_SPEED': 100, 'ONI_DEVICE_PROPERTY_IMAGE_REGISTRATION': 5, 'ONI_DEVICE_PROPERTY_DRIVER_VERSION': 1, 'ONI_DEVICE_PROPERTY_PLAYBACK_REPEAT_ENABLED': 101, 'ONI_DEVICE_PROPERTY_ERROR_STATE': 4, 'ONI_DEVICE_PROPERTY_HARDWARE_VERSION': 2, 'ONI_DEVICE_PROPERTY_FIRMWARE_VERSION': 0, 'ONI_DEVICE_PROPERTY_SERIAL_NUMBER': 3}
    _values_ = {0: 'ONI_DEVICE_PROPERTY_FIRMWARE_VERSION', 1: 'ONI_DEVICE_PROPERTY_DRIVER_VERSION', 2: 'ONI_DEVICE_PROPERTY_HARDWARE_VERSION', 3: 'ONI_DEVICE_PROPERTY_SERIAL_NUMBER', 4: 'ONI_DEVICE_PROPERTY_ERROR_STATE', 5: 'ONI_DEVICE_PROPERTY_IMAGE_REGISTRATION', 100: 'ONI_DEVICE_PROPERTY_PLAYBACK_SPEED', 101: 'ONI_DEVICE_PROPERTY_PLAYBACK_REPEAT_ENABLED'}
...
class _anon_enum_17(CEnum):
    _names_ = {'ONI_STREAM_PROPERTY_MIRRORING': 7, 'ONI_STREAM_PROPERTY_GAIN': 103, 'ONI_STREAM_PROPERTY_NUMBER_OF_FRAMES': 8, 'ONI_STREAM_PROPERTY_AUTO_EXPOSURE': 101, 'ONI_STREAM_PROPERTY_STRIDE': 6, 'ONI_STREAM_PROPERTY_HORIZONTAL_FOV': 1, 'ONI_STREAM_PROPERTY_MIN_VALUE': 5, 'ONI_STREAM_PROPERTY_VERTICAL_FOV': 2, 'ONI_STREAM_PROPERTY_MAX_VALUE': 4, 'ONI_STREAM_PROPERTY_CROPPING': 0, 'ONI_STREAM_PROPERTY_EXPOSURE': 102, 'ONI_STREAM_PROPERTY_AUTO_WHITE_BALANCE': 100, 'ONI_STREAM_PROPERTY_VIDEO_MODE': 3}
    _values_ = {0: 'ONI_STREAM_PROPERTY_CROPPING', 1: 'ONI_STREAM_PROPERTY_HORIZONTAL_FOV', 2: 'ONI_STREAM_PROPERTY_VERTICAL_FOV', 3: 'ONI_STREAM_PROPERTY_VIDEO_MODE', 4: 'ONI_STREAM_PROPERTY_MAX_VALUE', 5: 'ONI_STREAM_PROPERTY_MIN_VALUE', 6: 'ONI_STREAM_PROPERTY_STRIDE', 7: 'ONI_STREAM_PROPERTY_MIRRORING', 8: 'ONI_STREAM_PROPERTY_NUMBER_OF_FRAMES', 103: 'ONI_STREAM_PROPERTY_GAIN', 100: 'ONI_STREAM_PROPERTY_AUTO_WHITE_BALANCE', 102: 'ONI_STREAM_PROPERTY_EXPOSURE', 101: 'ONI_STREAM_PROPERTY_AUTO_EXPOSURE'}
...
class _anon_enum_19(CEnum):
    _names_ = {'XN_STREAM_PROPERTY_REGISTRATION_TYPE': 276828165, 'XN_MODULE_PROPERTY_FIRMWARE_FRAME_SYNC': 276885512, 'XN_MODULE_PROPERTY_MIRROR': 276885506, 'XN_STREAM_PROPERTY_PARAM_COEFF': 276828170, 'XN_MODULE_PROPERTY_FIRMWARE_PARAM': 276881409, 'XN_STREAM_PROPERTY_WAVELENGTH_CORRECTION': 276889414, 'XN_MODULE_PROPERTY_FIRMWARE_CPU_INTERVAL': 276889475, 'XN_MODULE_PROPERTY_FILE': 276889478, 'XN_MODULE_PROPERTY_SERIAL_NUMBER': 276885510, 'XN_MODULE_PROPERTY_IMAGE_CONTROL': 276881411, 'XN_STREAM_PROPERTY_FLICKER': 276832257, 'XN_MODULE_PROPERTY_FILE_ATTRIBUTES': 276889480, 'XN_MODULE_PROPERTY_PRINT_FIRMWARE_LOG': 276889472, 'XN_MODULE_PROPERTY_TEC_SET_POINT': 276889481, 'XN_MODULE_PROPERTY_FIRMWARE_LOG_FILTER': 276889473, 'XN_STREAM_PROPERTY_PIXEL_REGISTRATION': 276828161, 'XN_MODULE_PROPERTY_SENSOR_PLATFORM_STRING': 276889468, 'XN_STREAM_PROPERTY_S2D_TABLE': 276828176, 'XN_MODULE_PROPERTY_CMOS_BLANKING_UNITS': 276889460, 'XN_STREAM_PROPERTY_AGC_BIN': 276828166, 'XN_MODULE_PROPERTY_EMITTER_SET_POINT': 276889484, 'XN_MODULE_PROPERTY_EMITTER_STATUS': 276889485, 'XN_STREAM_PROPERTY_GMC_DEBUG': 276889413, 'XN_STREAM_PROPERTY_WAVELENGTH_CORRECTION_DEBUG': 276889415, 'XN_MODULE_PROPERTY_EMITTER_STATE': 276881415, 'XN_MODULE_PROPERTY_DEPTH_CONTROL': 276881412, 'XN_STREAM_PROPERTY_DEPTH_SENSOR_CALIBRATION_INFO': 276828178, 'XN_STREAM_PROPERTY_CONST_SHIFT': 276828167, 'XN_STREAM_PROPERTY_DCMOS_RCMOS_DISTANCE': 276828175, 'XN_STREAM_PROPERTY_MAX_SHIFT': 276828169, 'XN_MODULE_PROPERTY_I2C': 276889486, 'XN_STREAM_PROPERTY_EMITTER_DCMOS_DISTANCE': 276828174, 'XN_MODULE_PROPERTY_RESET': 276881410, 'XN_STREAM_PROPERTY_GMC_MODE': 276889412, 'XN_MODULE_PROPERTY_RESET_SENSOR_ON_STARTUP': 276885508, 'XN_MODULE_PROPERTY_CLOSE_STREAMS_ON_SHUTDOWN': 276889464, 'XN_MODULE_PROPERTY_FIRMWARE_LOG_INTERVAL': 276889471, 'XN_STREAM_PROPERTY_INPUT_FORMAT': 276824065, 'XN_MODULE_PROPERTY_TEC_FAST_CONVERGENCE_STATUS': 276889483, 'XN_MODULE_PROPERTY_PROJECTOR_FAULT': 276889488, 'XN_MODULE_PROPERTY_CMOS_BLANKING_TIME': 276889461, 'XN_MODULE_PROPERTY_PHYSICAL_DEVICE_NAME': 276889466, 'XN_MODULE_PROPERTY_HOST_TIMESTAMPS': 276889463, 'XN_STREAM_PROPERTY_SHIFT_SCALE': 276828171, 'XN_STREAM_PROPERTY_WHITE_BALANCE_ENABLED': 276828162, 'XN_STREAM_PROPERTY_ZERO_PLANE_PIXEL_SIZE': 276828173, 'XN_MODULE_PROPERTY_AHB': 276881413, 'XN_MODULE_PROPERTY_USB_INTERFACE': 276885505, 'XN_STREAM_PROPERTY_CLOSE_RANGE': 276885507, 'XN_MODULE_PROPERTY_BIST': 276889487, 'XN_MODULE_PROPERTY_LED_STATE': 276881414, 'XN_MODULE_PROPERTY_FLASH_CHUNK': 276889477, 'XN_STREAM_PROPERTY_D2S_TABLE': 276828177, 'XN_MODULE_PROPERTY_FILE_LIST': 276889476, 'XN_STREAM_PROPERTY_GAIN': 276828163, 'XN_STREAM_PROPERTY_CROPPING_MODE': 276824066, 'XN_STREAM_PROPERTY_HOLE_FILTER': 276828164, 'XN_MODULE_PROPERTY_VERSION': 276885511, 'XN_MODULE_PROPERTY_DELETE_FILE': 276889479, 'XN_STREAM_PROPERTY_ZERO_PLANE_DISTANCE': 276828172, 'XN_MODULE_PROPERTY_TEC_STATUS': 276889482, 'XN_MODULE_PROPERTY_FIRMWARE_TEC_DEBUG_PRINT': 276889490, 'XN_MODULE_PROPERTY_VENDOR_SPECIFIC_DATA': 276889467, 'XN_MODULE_PROPERTY_LEAN_INIT': 276885509, 'XN_MODULE_PROPERTY_APC_ENABLED': 276889489, 'XN_MODULE_PROPERTY_FIRMWARE_LOG': 276889474, 'XN_STREAM_PROPERTY_PIXEL_SIZE_FACTOR': 276828168}
    _values_ = {276889472: 'XN_MODULE_PROPERTY_PRINT_FIRMWARE_LOG', 276885505: 'XN_MODULE_PROPERTY_USB_INTERFACE', 276885506: 'XN_MODULE_PROPERTY_MIRROR', 276889475: 'XN_MODULE_PROPERTY_FIRMWARE_CPU_INTERVAL', 276885508: 'XN_MODULE_PROPERTY_RESET_SENSOR_ON_STARTUP', 276885509: 'XN_MODULE_PROPERTY_LEAN_INIT', 276885510: 'XN_MODULE_PROPERTY_SERIAL_NUMBER', 276885511: 'XN_MODULE_PROPERTY_VERSION', 276885512: 'XN_MODULE_PROPERTY_FIRMWARE_FRAME_SYNC', 276889481: 'XN_MODULE_PROPERTY_TEC_SET_POINT', 276889482: 'XN_MODULE_PROPERTY_TEC_STATUS', 276889483: 'XN_MODULE_PROPERTY_TEC_FAST_CONVERGENCE_STATUS', 276889484: 'XN_MODULE_PROPERTY_EMITTER_SET_POINT', 276889474: 'XN_MODULE_PROPERTY_FIRMWARE_LOG', 276889486: 'XN_MODULE_PROPERTY_I2C', 276889487: 'XN_MODULE_PROPERTY_BIST', 276889488: 'XN_MODULE_PROPERTY_PROJECTOR_FAULT', 276889489: 'XN_MODULE_PROPERTY_APC_ENABLED', 276889490: 'XN_MODULE_PROPERTY_FIRMWARE_TEC_DEBUG_PRINT', 276881411: 'XN_MODULE_PROPERTY_IMAGE_CONTROL', 276889413: 'XN_STREAM_PROPERTY_GMC_DEBUG', 276889477: 'XN_MODULE_PROPERTY_FLASH_CHUNK', 276881412: 'XN_MODULE_PROPERTY_DEPTH_CONTROL', 276828165: 'XN_STREAM_PROPERTY_REGISTRATION_TYPE', 276881413: 'XN_MODULE_PROPERTY_AHB', 276889473: 'XN_MODULE_PROPERTY_FIRMWARE_LOG_FILTER', 276889476: 'XN_MODULE_PROPERTY_FILE_LIST', 276881409: 'XN_MODULE_PROPERTY_FIRMWARE_PARAM', 276881414: 'XN_MODULE_PROPERTY_LED_STATE', 276881415: 'XN_MODULE_PROPERTY_EMITTER_STATE', 276889480: 'XN_MODULE_PROPERTY_FILE_ATTRIBUTES', 276832257: 'XN_STREAM_PROPERTY_FLICKER', 276824065: 'XN_STREAM_PROPERTY_INPUT_FORMAT', 276889478: 'XN_MODULE_PROPERTY_FILE', 276828169: 'XN_STREAM_PROPERTY_MAX_SHIFT', 276828161: 'XN_STREAM_PROPERTY_PIXEL_REGISTRATION', 276828166: 'XN_STREAM_PROPERTY_AGC_BIN', 276828170: 'XN_STREAM_PROPERTY_PARAM_COEFF', 276828173: 'XN_STREAM_PROPERTY_ZERO_PLANE_PIXEL_SIZE', 276881410: 'XN_MODULE_PROPERTY_RESET', 276828171: 'XN_STREAM_PROPERTY_SHIFT_SCALE', 276889412: 'XN_STREAM_PROPERTY_GMC_MODE', 276828162: 'XN_STREAM_PROPERTY_WHITE_BALANCE_ENABLED', 276889414: 'XN_STREAM_PROPERTY_WAVELENGTH_CORRECTION', 276889415: 'XN_STREAM_PROPERTY_WAVELENGTH_CORRECTION_DEBUG', 276828172: 'XN_STREAM_PROPERTY_ZERO_PLANE_DISTANCE', 276824066: 'XN_STREAM_PROPERTY_CROPPING_MODE', 276889485: 'XN_MODULE_PROPERTY_EMITTER_STATUS', 276889479: 'XN_MODULE_PROPERTY_DELETE_FILE', 276828174: 'XN_STREAM_PROPERTY_EMITTER_DCMOS_DISTANCE', 276828167: 'XN_STREAM_PROPERTY_CONST_SHIFT', 276828175: 'XN_STREAM_PROPERTY_DCMOS_RCMOS_DISTANCE', 276885507: 'XN_STREAM_PROPERTY_CLOSE_RANGE', 276828176: 'XN_STREAM_PROPERTY_S2D_TABLE', 276828163: 'XN_STREAM_PROPERTY_GAIN', 276828177: 'XN_STREAM_PROPERTY_D2S_TABLE', 276828178: 'XN_STREAM_PROPERTY_DEPTH_SENSOR_CALIBRATION_INFO', 276889460: 'XN_MODULE_PROPERTY_CMOS_BLANKING_UNITS', 276889461: 'XN_MODULE_PROPERTY_CMOS_BLANKING_TIME', 276828168: 'XN_STREAM_PROPERTY_PIXEL_SIZE_FACTOR', 276889463: 'XN_MODULE_PROPERTY_HOST_TIMESTAMPS', 276889464: 'XN_MODULE_PROPERTY_CLOSE_STREAMS_ON_SHUTDOWN', 276889466: 'XN_MODULE_PROPERTY_PHYSICAL_DEVICE_NAME', 276889467: 'XN_MODULE_PROPERTY_VENDOR_SPECIFIC_DATA', 276889468: 'XN_MODULE_PROPERTY_SENSOR_PLATFORM_STRING', 276828164: 'XN_STREAM_PROPERTY_HOLE_FILTER', 276889471: 'XN_MODULE_PROPERTY_FIRMWARE_LOG_INTERVAL'}
...
class XnFWVer(CEnum):
    _names_ = {'XN_SENSOR_FW_VER_5_6': 12, 'XN_SENSOR_FW_VER_5_2': 8, 'XN_SENSOR_FW_VER_5_0': 6, 'XN_SENSOR_FW_VER_5_1': 7, 'XN_SENSOR_FW_VER_0_17': 1, 'XN_SENSOR_FW_VER_5_3': 9, 'XN_SENSOR_FW_VER_5_4': 10, 'XN_SENSOR_FW_VER_1_1': 2, 'XN_SENSOR_FW_VER_1_2': 3, 'XN_SENSOR_FW_VER_5_7': 13, 'XN_SENSOR_FW_VER_5_8': 14, 'XN_SENSOR_FW_VER_4_0': 5, 'XN_SENSOR_FW_VER_UNKNOWN': 0, 'XN_SENSOR_FW_VER_3_0': 4, 'XN_SENSOR_FW_VER_5_5': 11}
    _values_ = {0: 'XN_SENSOR_FW_VER_UNKNOWN', 1: 'XN_SENSOR_FW_VER_0_17', 2: 'XN_SENSOR_FW_VER_1_1', 3: 'XN_SENSOR_FW_VER_1_2', 4: 'XN_SENSOR_FW_VER_3_0', 5: 'XN_SENSOR_FW_VER_4_0', 6: 'XN_SENSOR_FW_VER_5_0', 7: 'XN_SENSOR_FW_VER_5_1', 8: 'XN_SENSOR_FW_VER_5_2', 9: 'XN_SENSOR_FW_VER_5_3', 10: 'XN_SENSOR_FW_VER_5_4', 11: 'XN_SENSOR_FW_VER_5_5', 12: 'XN_SENSOR_FW_VER_5_6', 13: 'XN_SENSOR_FW_VER_5_7', 14: 'XN_SENSOR_FW_VER_5_8'}
...
class XnSensorVer(CEnum):
    _names_ = {'XN_SENSOR_VER_3_0': 2, 'XN_SENSOR_VER_4_0': 3, 'XN_SENSOR_VER_5_0': 4, 'XN_SENSOR_VER_2_0': 1, 'XN_SENSOR_VER_UNKNOWN': 0}
    _values_ = {0: 'XN_SENSOR_VER_UNKNOWN', 1: 'XN_SENSOR_VER_2_0', 2: 'XN_SENSOR_VER_3_0', 3: 'XN_SENSOR_VER_4_0', 4: 'XN_SENSOR_VER_5_0'}
...
class XnHWVer(CEnum):
    _names_ = {'XN_SENSOR_HW_VER_RD1081': 5, 'XN_SENSOR_HW_VER_RD1082': 6, 'XN_SENSOR_HW_VER_FPDB_10': 1, 'XN_SENSOR_HW_VER_CDB_10': 2, 'XN_SENSOR_HW_VER_UNKNOWN': 0, 'XN_SENSOR_HW_VER_RD_5': 4, 'XN_SENSOR_HW_VER_RD109': 7, 'XN_SENSOR_HW_VER_RD_3': 3}
    _values_ = {0: 'XN_SENSOR_HW_VER_UNKNOWN', 1: 'XN_SENSOR_HW_VER_FPDB_10', 2: 'XN_SENSOR_HW_VER_CDB_10', 3: 'XN_SENSOR_HW_VER_RD_3', 4: 'XN_SENSOR_HW_VER_RD_5', 5: 'XN_SENSOR_HW_VER_RD1081', 6: 'XN_SENSOR_HW_VER_RD1082', 7: 'XN_SENSOR_HW_VER_RD109'}
...
class XnChipVer(CEnum):
    _names_ = {'XN_SENSOR_CHIP_VER_PS1000': 1, 'XN_SENSOR_CHIP_VER_PS1080': 2, 'XN_SENSOR_CHIP_VER_PS1080A6': 3, 'XN_SENSOR_CHIP_VER_UNKNOWN': 0}
    _values_ = {0: 'XN_SENSOR_CHIP_VER_UNKNOWN', 1: 'XN_SENSOR_CHIP_VER_PS1000', 2: 'XN_SENSOR_CHIP_VER_PS1080', 3: 'XN_SENSOR_CHIP_VER_PS1080A6'}
...
class XnCMOSType(CEnum):
    _names_ = {'XN_CMOS_TYPE_IMAGE': 0, 'XN_CMOS_COUNT': 2, 'XN_CMOS_TYPE_DEPTH': 1}
    _values_ = {0: 'XN_CMOS_TYPE_IMAGE', 1: 'XN_CMOS_TYPE_DEPTH', 2: 'XN_CMOS_COUNT'}
    XN_CMOS_TYPE_IMAGE = 0
    XN_CMOS_TYPE_DEPTH = 1
    XN_CMOS_COUNT = 2

class XnIOImageFormats(CEnum):
    _names_ = {'XN_IO_IMAGE_FORMAT_UNCOMPRESSED_YUYV': 7, 'XN_IO_IMAGE_FORMAT_UNCOMPRESSED_YUV422': 5, 'XN_IO_IMAGE_FORMAT_UNCOMPRESSED_BAYER': 6, 'XN_IO_IMAGE_FORMAT_BAYER': 0, 'XN_IO_IMAGE_FORMAT_JPEG': 2, 'XN_IO_IMAGE_FORMAT_JPEG_420': 3, 'XN_IO_IMAGE_FORMAT_JPEG_MONO': 4, 'XN_IO_IMAGE_FORMAT_YUV422': 1}
    _values_ = {0: 'XN_IO_IMAGE_FORMAT_BAYER', 1: 'XN_IO_IMAGE_FORMAT_YUV422', 2: 'XN_IO_IMAGE_FORMAT_JPEG', 3: 'XN_IO_IMAGE_FORMAT_JPEG_420', 4: 'XN_IO_IMAGE_FORMAT_JPEG_MONO', 5: 'XN_IO_IMAGE_FORMAT_UNCOMPRESSED_YUV422', 6: 'XN_IO_IMAGE_FORMAT_UNCOMPRESSED_BAYER', 7: 'XN_IO_IMAGE_FORMAT_UNCOMPRESSED_YUYV'}
...
class XnIODepthFormats(CEnum):
    _names_ = {'XN_IO_DEPTH_FORMAT_UNCOMPRESSED_16_BIT': 0, 'XN_IO_DEPTH_FORMAT_COMPRESSED_PS': 1, 'XN_IO_DEPTH_FORMAT_UNCOMPRESSED_12_BIT': 4, 'XN_IO_DEPTH_FORMAT_UNCOMPRESSED_11_BIT': 3, 'XN_IO_DEPTH_FORMAT_UNCOMPRESSED_10_BIT': 2}
    _values_ = {0: 'XN_IO_DEPTH_FORMAT_UNCOMPRESSED_16_BIT', 1: 'XN_IO_DEPTH_FORMAT_COMPRESSED_PS', 2: 'XN_IO_DEPTH_FORMAT_UNCOMPRESSED_10_BIT', 3: 'XN_IO_DEPTH_FORMAT_UNCOMPRESSED_11_BIT', 4: 'XN_IO_DEPTH_FORMAT_UNCOMPRESSED_12_BIT'}
...
class XnParamResetType(CEnum):
    _names_ = {'XN_RESET_TYPE_POWER': 0, 'XN_RESET_TYPE_SOFT': 1, 'XN_RESET_TYPE_SOFT_FIRST': 2}
    _values_ = {0: 'XN_RESET_TYPE_POWER', 1: 'XN_RESET_TYPE_SOFT', 2: 'XN_RESET_TYPE_SOFT_FIRST'}
    XN_RESET_TYPE_POWER = 0
    XN_RESET_TYPE_SOFT = 1
    XN_RESET_TYPE_SOFT_FIRST = 2

class XnSensorUsbInterface(CEnum):
    _names_ = {'XN_SENSOR_USB_INTERFACE_ISO_ENDPOINTS': 1, 'XN_SENSOR_USB_INTERFACE_DEFAULT': 0, 'XN_SENSOR_USB_INTERFACE_BULK_ENDPOINTS': 2, 'XN_SENSOR_USB_INTERFACE_ISO_ENDPOINTS_LOW_DEPTH': 3}
    _values_ = {0: 'XN_SENSOR_USB_INTERFACE_DEFAULT', 1: 'XN_SENSOR_USB_INTERFACE_ISO_ENDPOINTS', 2: 'XN_SENSOR_USB_INTERFACE_BULK_ENDPOINTS', 3: 'XN_SENSOR_USB_INTERFACE_ISO_ENDPOINTS_LOW_DEPTH'}
...
class XnProcessingType(CEnum):
    _names_ = {'XN_PROCESSING_HARDWARE': 1, 'XN_PROCESSING_SOFTWARE': 2, 'XN_PROCESSING_DONT_CARE': 0}
    _values_ = {0: 'XN_PROCESSING_DONT_CARE', 1: 'XN_PROCESSING_HARDWARE', 2: 'XN_PROCESSING_SOFTWARE'}
    XN_PROCESSING_DONT_CARE = 0
    XN_PROCESSING_HARDWARE = 1
    XN_PROCESSING_SOFTWARE = 2

class XnCroppingMode(CEnum):
    _names_ = {'XN_CROPPING_MODE_SOFTWARE_ONLY': 3, 'XN_CROPPING_MODE_INCREASED_FPS': 2, 'XN_CROPPING_MODE_NORMAL': 1}
    _values_ = {1: 'XN_CROPPING_MODE_NORMAL', 2: 'XN_CROPPING_MODE_INCREASED_FPS', 3: 'XN_CROPPING_MODE_SOFTWARE_ONLY'}
    XN_CROPPING_MODE_NORMAL = 1
    XN_CROPPING_MODE_INCREASED_FPS = 2
    XN_CROPPING_MODE_SOFTWARE_ONLY = 3

class _anon_enum_28(CEnum):
    _names_ = {'XN_ERROR_STATE_OK': 0, 'XN_ERROR_STATE_DEVICE_PROJECTOR_FAULT': 1, 'XN_ERROR_STATE_DEVICE_OVERHEAT': 2}
    _values_ = {0: 'XN_ERROR_STATE_OK', 1: 'XN_ERROR_STATE_DEVICE_PROJECTOR_FAULT', 2: 'XN_ERROR_STATE_DEVICE_OVERHEAT'}
    XN_ERROR_STATE_OK = 0
...
class XnFirmwareCroppingMode(CEnum):
    _names_ = {'XN_FIRMWARE_CROPPING_MODE_DISABLED': 0, 'XN_FIRMWARE_CROPPING_MODE_INCREASED_FPS': 2, 'XN_FIRMWARE_CROPPING_MODE_NORMAL': 1}
    _values_ = {0: 'XN_FIRMWARE_CROPPING_MODE_DISABLED', 1: 'XN_FIRMWARE_CROPPING_MODE_NORMAL', 2: 'XN_FIRMWARE_CROPPING_MODE_INCREASED_FPS'}
...
class XnLogFilter(CEnum):
    _names_ = {'XnLogFilterAssert': 16, 'XnLogFilterError': 4, 'XnLogFilterAll': 65535, 'XnLogFilterProtocol': 8, 'XnLogFilterTelems': 256, 'XnLogFilterFrameSync': 64, 'XnLogFilterInfo': 2, 'XnLogFilterAGC': 128, 'XnLogFilterConfig': 32, 'XnLogFilterDebug': 1}
    _values_ = {32: 'XnLogFilterConfig', 1: 'XnLogFilterDebug', 2: 'XnLogFilterInfo', 4: 'XnLogFilterError', 8: 'XnLogFilterProtocol', 64: 'XnLogFilterFrameSync', 128: 'XnLogFilterAGC', 256: 'XnLogFilterTelems', 16: 'XnLogFilterAssert', 65535: 'XnLogFilterAll'}
    XnLogFilterDebug = 1
    XnLogFilterInfo = 2
    XnLogFilterError = 4
...
class XnFlashFileType(CEnum):
    _names_ = {'XnFlashFileTypeAlgorithmParams': 12, 'XnFlashFileTypeCodeDownloader': 4, 'XnFlashFileTypeWavelengthCorrection': 26, 'XnFlashFileTypeSensorTECParams': 21, 'XnFlashFileTypeFileTable': 0, 'XnFlashFileTypeDefaultParams': 9, 'XnFlashFileTypeReferenceQVGA': 13, 'XnFlashFileTypeGMCReferenceOffset': 27, 'XnFlashFileTypeApplication': 6, 'XnFlashFileTypeSensorAPCParams': 22, 'XnFlashFileTypeBootSector': 2, 'XnFlashFileTypeSensorFault': 29, 'XnFlashFileTypeMonitor': 5, 'XnFlashFileTypeDescriptors': 8, 'XnFlashFileTypeImageCmos': 10, 'XnFlashFileTypeProductionFile': 24, 'XnFlashFileTypeScratchFile': 1, 'XnFlashFileTypeReferenceVGA': 14, 'XnFlashFileTypeMaintenance': 15, 'XnFlashFileTypeSensorProjectorFaultParams': 23, 'XnFlashFileTypeIDParams': 20, 'XnFlashFileTypeUpgradeInProgress': 25, 'XnFlashFileTypePrimeProcessor': 17, 'XnFlashFileTypeDepthCmos': 11, 'XnFlashFileTypeGainControl': 18, 'XnFlashFileTypeVendorData': 30, 'XnFlashFileTypeRegistartionParams': 19, 'XnFlashFileTypeDebugParams': 16, 'XnFlashFileTypeFixedParams': 7, 'XnFlashFileTypeBootManager': 3, 'XnFlashFileTypeSensorNESAParams': 28}
    _values_ = {0: 'XnFlashFileTypeFileTable', 1: 'XnFlashFileTypeScratchFile', 2: 'XnFlashFileTypeBootSector', 3: 'XnFlashFileTypeBootManager', 4: 'XnFlashFileTypeCodeDownloader', 5: 'XnFlashFileTypeMonitor', 6: 'XnFlashFileTypeApplication', 7: 'XnFlashFileTypeFixedParams', 8: 'XnFlashFileTypeDescriptors', 9: 'XnFlashFileTypeDefaultParams', 10: 'XnFlashFileTypeImageCmos', 11: 'XnFlashFileTypeDepthCmos', 12: 'XnFlashFileTypeAlgorithmParams', 13: 'XnFlashFileTypeReferenceQVGA', 14: 'XnFlashFileTypeReferenceVGA', 15: 'XnFlashFileTypeMaintenance', 16: 'XnFlashFileTypeDebugParams', 17: 'XnFlashFileTypePrimeProcessor', 18: 'XnFlashFileTypeGainControl', 19: 'XnFlashFileTypeRegistartionParams', 20: 'XnFlashFileTypeIDParams', 21: 'XnFlashFileTypeSensorTECParams', 22: 'XnFlashFileTypeSensorAPCParams', 23: 'XnFlashFileTypeSensorProjectorFaultParams', 24: 'XnFlashFileTypeProductionFile', 25: 'XnFlashFileTypeUpgradeInProgress', 26: 'XnFlashFileTypeWavelengthCorrection', 27: 'XnFlashFileTypeGMCReferenceOffset', 28: 'XnFlashFileTypeSensorNESAParams', 29: 'XnFlashFileTypeSensorFault', 30: 'XnFlashFileTypeVendorData'}
...
class XnBistType(CEnum):
    _names_ = {'XN_BIST_FULL_FLASH': 16, 'XN_BIST_FLASH': 8, 'XN_BIST_TEC_TEST_MASK': 64, 'XN_BIST_NESA_UNLIMITED_TEST_MASK': 256, 'XN_BIST_POTENTIOMETER': 4, 'XN_BIST_PROJECTOR_TEST_MASK': 32, 'XN_BIST_IMAGE_CMOS': 1, 'XN_BIST_NESA_TEST_MASK': 128, 'XN_BIST_ALL': '((4294967295 & (~XN_BIST_NESA_TEST_MASK)) & (~XN_BIST_NESA_UNLIMITED_TEST_MASK))', 'XN_BIST_IR_CMOS': 2}
    _values_ = {32: 'XN_BIST_PROJECTOR_TEST_MASK', 1: 'XN_BIST_IMAGE_CMOS', 2: 'XN_BIST_IR_CMOS', 4: 'XN_BIST_POTENTIOMETER', 8: 'XN_BIST_FLASH', 64: 'XN_BIST_TEC_TEST_MASK', 128: 'XN_BIST_NESA_TEST_MASK', 256: 'XN_BIST_NESA_UNLIMITED_TEST_MASK', 16: 'XN_BIST_FULL_FLASH', '((4294967295 & (~XN_BIST_NESA_TEST_MASK)) & (~XN_BIST_NESA_UNLIMITED_TEST_MASK))': 'XN_BIST_ALL'}
...
class XnBistError(CEnum):
    _names_ = {'XN_BIST_COLOR_CMOS_CONTROL_BUS_FAILURE': 128, 'XN_TEC_TEST_HEATER_CROSSED': 1048576, 'XN_BIST_PROJECTOR_TEST_LD_FAIL': 65536, 'XN_BIST_COLOR_CMOS_RESET_FAILUE': 1024, 'XN_BIST_FLASH_WRITE_LINE_FAILURE': 2048, 'XN_BIST_IR_CMOS_DATA_BUS_FAILURE': 4, 'XN_BIST_IR_CMOS_TRIGGER_FAILURE': 32, 'XN_BIST_RAM_TEST_FAILURE': 1, 'XN_BIST_PROJECTOR_TEST_FAILSAFE_HIGH_FAIL': 262144, 'XN_BIST_POTENTIOMETER_CONTROL_BUS_FAILURE': 8192, 'XN_BIST_AUDIO_TEST_FAILURE': 32768, 'XN_BIST_IR_CMOS_STROBE_FAILURE': 64, 'XN_BIST_PROJECTOR_TEST_FAILSAFE_LOW_FAIL': 524288, 'XN_BIST_IR_CMOS_RESET_FAILUE': 16, 'XN_BIST_IR_CMOS_CONTROL_BUS_FAILURE': 2, 'XN_BIST_PROJECTOR_TEST_LD_FAILSAFE_TRIG_FAIL': 131072, 'XN_BIST_COLOR_CMOS_BAD_VERSION': 512, 'XN_BIST_FLASH_TEST_FAILURE': 4096, 'XN_BIST_COLOR_CMOS_DATA_BUS_FAILURE': 256, 'XN_TEC_TEST_TEC_CROSSED': 4194304, 'XN_TEC_TEST_TEC_FAULT': 8388608, 'XN_BIST_POTENTIOMETER_FAILURE': 16384, 'XN_BIST_IR_CMOS_BAD_VERSION': 8, 'XN_TEC_TEST_HEATER_DISCONNETED': 2097152}
    _values_ = {4096: 'XN_BIST_FLASH_TEST_FAILURE', 1: 'XN_BIST_RAM_TEST_FAILURE', 2: 'XN_BIST_IR_CMOS_CONTROL_BUS_FAILURE', 4: 'XN_BIST_IR_CMOS_DATA_BUS_FAILURE', 8192: 'XN_BIST_POTENTIOMETER_CONTROL_BUS_FAILURE', 8: 'XN_BIST_IR_CMOS_BAD_VERSION', 128: 'XN_BIST_COLOR_CMOS_CONTROL_BUS_FAILURE', 256: 'XN_BIST_COLOR_CMOS_DATA_BUS_FAILURE', 16: 'XN_BIST_IR_CMOS_RESET_FAILUE', 8388608: 'XN_TEC_TEST_TEC_FAULT', 512: 'XN_BIST_COLOR_CMOS_BAD_VERSION', 4194304: 'XN_TEC_TEST_TEC_CROSSED', 524288: 'XN_BIST_PROJECTOR_TEST_FAILSAFE_LOW_FAIL', 32: 'XN_BIST_IR_CMOS_TRIGGER_FAILURE', 131072: 'XN_BIST_PROJECTOR_TEST_LD_FAILSAFE_TRIG_FAIL', 262144: 'XN_BIST_PROJECTOR_TEST_FAILSAFE_HIGH_FAIL', 1024: 'XN_BIST_COLOR_CMOS_RESET_FAILUE', 16384: 'XN_BIST_POTENTIOMETER_FAILURE', 1048576: 'XN_TEC_TEST_HEATER_CROSSED', 32768: 'XN_BIST_AUDIO_TEST_FAILURE', 64: 'XN_BIST_IR_CMOS_STROBE_FAILURE', 2048: 'XN_BIST_FLASH_WRITE_LINE_FAILURE', 2097152: 'XN_TEC_TEST_HEATER_DISCONNETED', 65536: 'XN_BIST_PROJECTOR_TEST_LD_FAIL'}
...
class XnImageCMOSType(CEnum):
    _names_ = {'XN_IMAGE_CMOS_NONE': 0, 'XN_IMAGE_CMOS_MT9M114': 3, 'XN_IMAGE_CMOS_MT9M112': 1, 'XN_IMAGE_CMOS_MT9D131': 2}
    _values_ = {0: 'XN_IMAGE_CMOS_NONE', 1: 'XN_IMAGE_CMOS_MT9M112', 2: 'XN_IMAGE_CMOS_MT9D131', 3: 'XN_IMAGE_CMOS_MT9M114'}
...
class _anon_enum_40(CEnum):
    _names_ = {'PS_COMMAND_SET_LOG_MASK_STATE': 489152531, 'PS_COMMAND_AHB_READ': 489152513, 'PS_COMMAND_GET_FILE_LIST': 489152523, 'PS_COMMAND_POWER_RESET': 489152518, 'PS_COMMAND_DUMP_ENDPOINT': 489152525, 'PS_COMMAND_AHB_WRITE': 489152514, 'PS_COMMAND_I2C_READ': 489152515, 'PS_COMMAND_FORMAT_ZONE': 489152524, 'PS_COMMAND_STOP_LOG': 489152533, 'PS_COMMAND_BEGIN_FIRMWARE_UPDATE': 489152519, 'PS_COMMAND_I2C_WRITE': 489152516, 'PS_COMMAND_DOWNLOAD_FILE': 489152522, 'PS_COMMAND_START_LOG': 489152532, 'PS_COMMAND_SOFT_RESET': 489152517, 'PS_COMMAND_GET_BIST_LIST': 489152527, 'PS_COMMAND_EXECUTE_BIST': 489152528, 'PS_COMMAND_USB_TEST': 489152529, 'PS_COMMAND_END_FIRMWARE_UPDATE': 489152520, 'PS_COMMAND_GET_LOG_MASK_LIST': 489152530, 'PS_COMMAND_UPLOAD_FILE': 489152521, 'PS_COMMAND_GET_I2C_DEVICE_LIST': 489152526}
    _values_ = {489152513: 'PS_COMMAND_AHB_READ', 489152514: 'PS_COMMAND_AHB_WRITE', 489152515: 'PS_COMMAND_I2C_READ', 489152516: 'PS_COMMAND_I2C_WRITE', 489152517: 'PS_COMMAND_SOFT_RESET', 489152518: 'PS_COMMAND_POWER_RESET', 489152519: 'PS_COMMAND_BEGIN_FIRMWARE_UPDATE', 489152520: 'PS_COMMAND_END_FIRMWARE_UPDATE', 489152521: 'PS_COMMAND_UPLOAD_FILE', 489152522: 'PS_COMMAND_DOWNLOAD_FILE', 489152523: 'PS_COMMAND_GET_FILE_LIST', 489152524: 'PS_COMMAND_FORMAT_ZONE', 489152525: 'PS_COMMAND_DUMP_ENDPOINT', 489152526: 'PS_COMMAND_GET_I2C_DEVICE_LIST', 489152527: 'PS_COMMAND_GET_BIST_LIST', 489152528: 'PS_COMMAND_EXECUTE_BIST', 489152529: 'PS_COMMAND_USB_TEST', 489152530: 'PS_COMMAND_GET_LOG_MASK_LIST', 489152531: 'PS_COMMAND_SET_LOG_MASK_STATE', 489152532: 'PS_COMMAND_START_LOG', 489152533: 'PS_COMMAND_STOP_LOG'}
...
class XnUsbInterfaceType(CEnum):
    _names_ = {'PS_USB_INTERFACE_ISO_ENDPOINTS': 1, 'PS_USB_INTERFACE_DONT_CARE': 0, 'PS_USB_INTERFACE_BULK_ENDPOINTS': 2}
    _values_ = {0: 'PS_USB_INTERFACE_DONT_CARE', 1: 'PS_USB_INTERFACE_ISO_ENDPOINTS', 2: 'PS_USB_INTERFACE_BULK_ENDPOINTS'}
...
class _anon_enum_41(CEnum):
    _names_ = {'LINK_COMMAND_STOP_FW_STREAM': 302051333, 'LINK_COMMAND_CREATE_FW_STREAM': 302051330, 'LINK_PROP_PIXEL_FORMAT': 301993985, 'LINK_PROP_DEPTH_SCALE': 301989899, 'LINK_PROP_BOOT_STATUS': 301989899, 'LINK_PROP_VERSIONS_INFO_COUNT': 301989890, 'LINK_PROP_PRESET_FILE': 301989898, 'LINK_PROP_CONST_SHIFT': 301998083, 'LINK_COMMAND_GET_FW_STREAM_LIST': 302051329, 'LINK_PROP_EMITTER_DEPTH_CMOS_DISTANCE': 301998088, 'LINK_COMMAND_DESTROY_FW_STREAM': 302051331, 'LINK_PROP_MAX_SHIFT': 301998081, 'LINK_COMMAND_START_FW_STREAM': 302051332, 'LINK_PROP_EMITTER_ACTIVE': 301989896, 'LINK_COMMAND_SET_FW_STREAM_VIDEO_MODE': 302051335, 'LINK_PROP_PARAM_COEFF': 301998084, 'LINK_PROP_ZERO_PLANE_PIXEL_SIZE': 301998086, 'LINK_COMMAND_GET_FW_STREAM_VIDEO_MODE': 302051336, 'LINK_PROP_SHIFT_TO_DEPTH_TABLE': 301998089, 'LINK_PROP_COMPRESSION': 301993986, 'LINK_COMMAND_GET_FW_STREAM_VIDEO_MODE_LIST': 302051334, 'LINK_PROP_SHIFT_SCALE': 301998085, 'LINK_PROP_VERSIONS_INFO': 301989891, 'LINK_PROP_FW_VERSION': 301989889, 'LINK_PROP_ZERO_PLANE_DISTANCE': 301998082, 'LINK_PROP_ZERO_PLANE_OUTPUT_PIXEL_SIZE': 301998087, 'LINK_PROP_DEPTH_TO_SHIFT_TABLE': 301998090}
    _values_ = {301989889: 'LINK_PROP_FW_VERSION', 301998082: 'LINK_PROP_ZERO_PLANE_DISTANCE', 301989891: 'LINK_PROP_VERSIONS_INFO', 302051332: 'LINK_COMMAND_START_FW_STREAM', 302051333: 'LINK_COMMAND_STOP_FW_STREAM', 302051334: 'LINK_COMMAND_GET_FW_STREAM_VIDEO_MODE_LIST', 302051329: 'LINK_COMMAND_GET_FW_STREAM_LIST', 301989896: 'LINK_PROP_EMITTER_ACTIVE', 301998089: 'LINK_PROP_SHIFT_TO_DEPTH_TABLE', 301989898: 'LINK_PROP_PRESET_FILE', 301989899: 'LINK_PROP_DEPTH_SCALE', 301989890: 'LINK_PROP_VERSIONS_INFO_COUNT', 301998083: 'LINK_PROP_CONST_SHIFT', 301998084: 'LINK_PROP_PARAM_COEFF', 301998085: 'LINK_PROP_SHIFT_SCALE', 301993985: 'LINK_PROP_PIXEL_FORMAT', 301998086: 'LINK_PROP_ZERO_PLANE_PIXEL_SIZE', 302051335: 'LINK_COMMAND_SET_FW_STREAM_VIDEO_MODE', 302051336: 'LINK_COMMAND_GET_FW_STREAM_VIDEO_MODE', 301998090: 'LINK_PROP_DEPTH_TO_SHIFT_TABLE', 301998081: 'LINK_PROP_MAX_SHIFT', 302051330: 'LINK_COMMAND_CREATE_FW_STREAM', 301993986: 'LINK_PROP_COMPRESSION', 301998087: 'LINK_PROP_ZERO_PLANE_OUTPUT_PIXEL_SIZE', 302051331: 'LINK_COMMAND_DESTROY_FW_STREAM', 301998088: 'LINK_PROP_EMITTER_DEPTH_CMOS_DISTANCE'}
...
class XnFileZone(CEnum):
    _names_ = {'XN_ZONE_UPDATE': 1, 'XN_ZONE_FACTORY': 0}
    _values_ = {0: 'XN_ZONE_FACTORY', 1: 'XN_ZONE_UPDATE'}
    XN_ZONE_FACTORY = 0
    XN_ZONE_UPDATE = 1

class XnBootErrorCode(CEnum):
    _names_ = {'XN_BOOT_OK': 0, 'XN_BOOT_FW_LOAD_FAILED': 3, 'XN_BOOT_BAD_CRC': 1, 'XN_BOOT_UPLOAD_IN_PROGRESS': 2}
    _values_ = {0: 'XN_BOOT_OK', 1: 'XN_BOOT_BAD_CRC', 2: 'XN_BOOT_UPLOAD_IN_PROGRESS', 3: 'XN_BOOT_FW_LOAD_FAILED'}
    XN_BOOT_OK = 0
    XN_BOOT_BAD_CRC = 1
...
class XnFwStreamType(CEnum):
    _names_ = {'XN_FW_STREAM_TYPE_IR': 2, 'XN_FW_STREAM_TYPE_COLOR': 1, 'XN_FW_STREAM_TYPE_SHIFTS': 3, 'XN_FW_STREAM_TYPE_LOG': 8, 'XN_FW_STREAM_TYPE_AUDIO': 4, 'XN_FW_STREAM_TYPE_DY': 5}
    _values_ = {1: 'XN_FW_STREAM_TYPE_COLOR', 2: 'XN_FW_STREAM_TYPE_IR', 3: 'XN_FW_STREAM_TYPE_SHIFTS', 4: 'XN_FW_STREAM_TYPE_AUDIO', 5: 'XN_FW_STREAM_TYPE_DY', 8: 'XN_FW_STREAM_TYPE_LOG'}
...
class XnFwPixelFormat(CEnum):
    _names_ = {'XN_FW_PIXEL_FORMAT_SHIFTS_9_3': 1, 'XN_FW_PIXEL_FORMAT_NONE': 0, 'XN_FW_PIXEL_FORMAT_GRAYSCALE16': 2, 'XN_FW_PIXEL_FORMAT_BAYER8': 4, 'XN_FW_PIXEL_FORMAT_YUV422': 3}
    _values_ = {0: 'XN_FW_PIXEL_FORMAT_NONE', 1: 'XN_FW_PIXEL_FORMAT_SHIFTS_9_3', 2: 'XN_FW_PIXEL_FORMAT_GRAYSCALE16', 3: 'XN_FW_PIXEL_FORMAT_YUV422', 4: 'XN_FW_PIXEL_FORMAT_BAYER8'}
...
class XnFwCompressionType(CEnum):
    _names_ = {'XN_FW_COMPRESSION_8Z': 1, 'XN_FW_COMPRESSION_6_BIT_PACKED': 4, 'XN_FW_COMPRESSION_16Z': 2, 'XN_FW_COMPRESSION_24Z': 3, 'XN_FW_COMPRESSION_11_BIT_PACKED': 6, 'XN_FW_COMPRESSION_12_BIT_PACKED': 7, 'XN_FW_COMPRESSION_10_BIT_PACKED': 5, 'XN_FW_COMPRESSION_NONE': 0}
    _values_ = {0: 'XN_FW_COMPRESSION_NONE', 1: 'XN_FW_COMPRESSION_8Z', 2: 'XN_FW_COMPRESSION_16Z', 3: 'XN_FW_COMPRESSION_24Z', 4: 'XN_FW_COMPRESSION_6_BIT_PACKED', 5: 'XN_FW_COMPRESSION_10_BIT_PACKED', 6: 'XN_FW_COMPRESSION_11_BIT_PACKED', 7: 'XN_FW_COMPRESSION_12_BIT_PACKED'}
...
def load_dll(dllname):
    ...
    _oniReleaseDeviceList = _dll.oniReleaseDeviceList
    ...
    _oniRegisterDeviceCallbacks = _dll.oniRegisterDeviceCallbacks
    _oniRegisterDeviceCallbacks.restype  = OniStatus
    _oniRegisterDeviceCallbacks.argtypes = [ctypes.POINTER(OniDeviceCallbacks), ctypes.c_void_p, ctypes.POINTER(OniCallbackHandle)]

    global _oniUnregisterDeviceCallbacks
    _oniUnregisterDeviceCallbacks = _dll.oniUnregisterDeviceCallbacks
    ...
    _oniDeviceGetInfo = _dll.oniDeviceGetInfo
    ...
    _oniDeviceCreateStream = _dll.oniDeviceCreateStream
    ...
    _oniDeviceEnableDepthColorSync = _dll.oniDeviceEnableDepthColorSync
    ...
    _oniDeviceDisableDepthColorSync = _dll.oniDeviceDisableDepthColorSync
    ...
    _oniDeviceGetDepthColorSyncEnabled = _dll.oniDeviceGetDepthColorSyncEnabled
    ...
    _oniDeviceSetProperty = _dll.oniDeviceSetProperty
    ...
    _oniDeviceGetProperty = _dll.oniDeviceGetProperty
    ...
    _oniDeviceIsPropertySupported = _dll.oniDeviceIsPropertySupported
    ...
    _oniDeviceInvoke = _dll.oniDeviceInvoke
    ...
    _oniDeviceIsCommandSupported = _dll.oniDeviceIsCommandSupported
    ...
    _oniDeviceIsImageRegistrationModeSupported = _dll.oniDeviceIsImageRegistrationModeSupported
    ...
    _oniDeviceOpenEx = _dll.oniDeviceOpenEx
    ...
    _oniStreamRegisterNewFrameCallback = _dll.oniStreamRegisterNewFrameCallback
    _oniStreamRegisterNewFrameCallback.restype  = OniStatus
    _oniStreamRegisterNewFrameCallback.argtypes = [OniStreamHandle, OniNewFrameCallback, ctypes.c_void_p, ctypes.POINTER(OniCallbackHandle)]

    global _oniStreamUnregisterNewFrameCallback
    _oniStreamUnregisterNewFrameCallback = _dll.oniStreamUnregisterNewFrameCallback
    ...
    _oniStreamSetProperty = _dll.oniStreamSetProperty
    ...
    _oniStreamGetProperty = _dll.oniStreamGetProperty
    ...
    _oniStreamIsPropertySupported = _dll.oniStreamIsPropertySupported
    ...
    _oniStreamInvoke = _dll.oniStreamInvoke
    ...
    _oniStreamIsCommandSupported = _dll.oniStreamIsCommandSupported
    ...
    _oniStreamSetFrameBuffersAllocator = _dll.oniStreamSetFrameBuffersAllocator
    _oniStreamSetFrameBuffersAllocator.restype  = OniStatus
    _oniStreamSetFrameBuffersAllocator.argtypes = [OniStreamHandle, OniFrameAllocBufferCallback, OniFrameFreeBufferCallback, ctypes.c_void_p]

    global _oniFrameAddRef
    _oniFrameAddRef = _dll.oniFrameAddRef
    _oniFrameAddRef.restype  = None
    _oniFrameAddRef.argtypes = [ctypes.POINTER(OniFrame)]

    global _oniFrameRelease
    _oniFrameRelease = _dll.oniFrameRelease
    _oniFrameRelease.restype  = None
    _oniFrameRelease.argtypes = [ctypes.POINTER(OniFrame)]

    global _oniCreateRecorder
    _oniCreateRecorder = _dll.oniCreateRecorder
    ...
    _oniRecorderAttachStream = _dll.oniRecorderAttachStream
    ...
    _oniCoordinateConverterDepthToWorld = _dll.oniCoordinateConverterDepthToWorld
    _oniCoordinateConverterDepthToWorld.restype  = OniStatus
    _oniCoordinateConverterDepthToWorld.argtypes = [OniStreamHandle, ctypes.c_float, ctypes.c_float, ctypes.c_float, ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float)]

    global _oniCoordinateConverterWorldToDepth
    _oniCoordinateConverterWorldToDepth = _dll.oniCoordinateConverterWorldToDepth
    _oniCoordinateConverterWorldToDepth.restype  = OniStatus
    _oniCoordinateConverterWorldToDepth.argtypes = [OniStreamHandle, ctypes.c_float, ctypes.c_float, ctypes.c_float, ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float)]

    global _oniCoordinateConverterDepthToColor
    _oniCoordinateConverterDepthToColor = _dll.oniCoordinateConverterDepthToColor
    _oniCoordinateConverterDepthToColor.restype  = OniStatus
    _oniCoordinateConverterDepthToColor.argtypes = [OniStreamHandle, OniStreamHandle, ctypes.c_int, ctypes.c_int, OniDepthPixel, ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int)]

    global _oniSetLogOutputFolder
    _oniSetLogOutputFolder = _dll.oniSetLogOutputFolder
    _oniSetLogOutputFolder.restype  = OniStatus
    _oniSetLogOutputFolder.argtypes = [ctypes.c_char_p]

    global _oniGetLogFileName
    _oniGetLogFileName = _dll.oniGetLogFileName
    _oniGetLogFileName.restype  = OniStatus
    _oniGetLogFileName.argtypes = [ctypes.c_char_p, ctypes.c_int]

    global _oniSetLogMinSeverity
    _oniSetLogMinSeverity = _dll.oniSetLogMinSeverity
    _oniSetLogMinSeverity.restype  = OniStatus
    _oniSetLogMinSeverity.argtypes = [ctypes.c_int]

    global _oniSetLogConsoleOutput
    _oniSetLogConsoleOutput = _dll.oniSetLogConsoleOutput
    _oniSetLogConsoleOutput.restype  = OniStatus
    _oniSetLogConsoleOutput.argtypes = [OniBool]

    global _oniSetLogFileOutput
    _oniSetLogFileOutput = _dll.oniSetLogFileOutput
